...
아래는 [에픽의 영상](https://youtu.be/eoxYceDfKEM)의 일부분이다. 붉을수록 overdraw가 심하다는 것을 나타낸다. 바위끼리 겹쳐진 부분에서 overdraw가 심한 것을 알 수 있다.

![Overdraw in kit-bashing](resources/overdraw.png "겹쳐진 부분의 overdraw")
...
GPU 메모리도 CPU처럼 페이지로 이루어져 있다. 따라서, 지금 안 쓰이는 LOD의 클러스터를 디스크로 스왑할 수 있다. 가변 크기의 클러스터를 
...
[Brian Karis – A Deep Dive into Nanite Virtualized Geometry](https://youtu.be/eviSykqSUUw)  
[Brian Karis – HPG 2022 Keynote: The Journey to Nanite ](https://youtu.be/NRnj_lnpORU?list=LL)   
[Arseny Kapoulkine – Optimizing Geometry for the GPU 02:13:04](https://youtu.be/KtxiuFe83Hg?t=7984)  
[Federico Ponchio – Multiresolution structures for interactive visualization of very large 3D datasets](https://vcg.isti.cnr.it/~ponchio/download/ponchio_phd.pdf)  
